const fs = require('fs');
let html = fs.readFileSync('basics.html', 'utf8');
...
<head>
    ...
    <title>Kitchen Basics — Larder</title>
...
<header class="app-header">
    <div class="header-main">
        ...
        <nav class="nav-links">
            ...
            <a href="basics" class="nav-link active">Basics</a>
...
fs.writeFileSync('basics.html', html);
console.log('Wrote basics.html');
